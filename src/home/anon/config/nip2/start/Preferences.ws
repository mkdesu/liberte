...
<root xmlns="http://www.vips.ecs.soton.ac.uk/nip/7.25.0">
  <Workspace window_x="0" window_y="0" window_width="680" window_height="800" filename="$HOME/.nip2-7.26.4/start/./Preferences.ws" view="WORKSPACE_MODE_NOEDIT" scale="1" offset="0" lpane_position="100" lpane_open="false" rpane_position="400" rpane_open="false" local_defs="// private definitions for this workspace&#10;" name="Preferences">
    <Column x="6" y="3073" open="false" selected="false" sform="false" next="99" name="B" caption="Interface column -- don't touch this!">
    ...
    <Column x="6" y="2837" open="true" selected="false" sform="false" next="10" name="I" caption="Mosaic defaults">
    ...
    <Column x="6" y="2501" open="true" selected="false" sform="false" next="15" name="J" caption="Video for linux">
      <Subcolumn vislevel="3">
    ...
    <Column x="6" y="2214" open="true" selected="false" sform="false" next="12" name="K" caption="General video capture">
      <Subcolumn vislevel="3">
    ...
    <Column x="6" y="2078" open="true" selected="false" sform="false" next="3" name="M" caption="PNG save options">
      <Subcolumn vislevel="3">
    ...
    <Column x="6" y="1976" open="true" selected="false" sform="false" next="12" name="G" caption="PPM/PGM/PBM save">
      <Subcolumn vislevel="2">
    ...
    <Column x="6" y="1626" open="true" selected="false" sform="false" next="25" name="C" caption="TIFF save">
      <Subcolumn vislevel="2">
    ...
    <Column x="6" y="1524" open="true" selected="false" sform="false" next="4" name="O" caption="CSV save">
      <Subcolumn vislevel="3">
    ...
    <Column x="6" y="1354" open="true" selected="false" sform="false" next="9" name="A" caption="JPEG save">
      <Subcolumn vislevel="2">
    ...
    <Column x="6" y="1150" open="true" selected="false" sform="false" next="11" name="F" caption="Widgets">
      <Subcolumn vislevel="2">
    ...
    <Column x="6" y="1050" open="true" selected="false" sform="false" next="4" name="H" caption="Debug options">
      <Subcolumn vislevel="2">
    ...
    <Column x="6" y="912" open="true" selected="false" sform="false" next="5" name="L" caption="Help browser">
      <Subcolumn vislevel="3">
        <Row popup="false" name="L2">
          <Rhs vislevel="1" flags="1">
            <iText formula="String &quot;Command to start browser&quot; &quot;firefox&quot;"/>
            <Subcolumn vislevel="0"/>
            <String caption="Command to start browser" value="$BROWSER"/>
          </Rhs>
        </Row>
        <Row popup="false" name="L4">
          <Rhs vislevel="1" flags="1">
            ...
            <Subcolumn vislevel="0"/>
            <String caption="Go-to-page argument" value="'%s'"/>
          </Rhs>
        </Row>
      </Subcolumn>
    </Column>
    <Column x="6" y="740" open="true" selected="false" sform="false" next="5" name="N" caption="Paintbox ">
      <Subcolumn vislevel="3">
    ...
    <Column x="6" y="464" open="true" selected="false" sform="false" next="27" name="E" caption="Image display">
      <Subcolumn vislevel="2">
    ...
    <Column x="6" y="6" open="true" selected="true" sform="false" next="46" name="D" caption="Calculation">
      <Subcolumn vislevel="2">
        ...
        <Row popup="false" name="D4">
          <Rhs vislevel="1" flags="1">
            ...
            <Subcolumn vislevel="0"/>
            <String caption="Temporary files" value="$XDG_CACHE_HOME/nip2"/>
          </Rhs>
        </Row>
