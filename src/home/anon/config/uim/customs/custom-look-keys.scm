(define look-on-key '("zenkaku-hankaku" "<Control> "))
(define look-on-key? (make-key-predicate '("zenkaku-hankaku" "<Control> ")))
(define look-off-key '("zenkaku-hankaku" "<Control> "))
(define look-off-key? (make-key-predicate '("zenkaku-hankaku" "<Control> ")))
